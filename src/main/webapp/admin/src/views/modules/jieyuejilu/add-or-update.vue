    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='tushu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="书架" prop="shujiaValue">
                        <el-input v-model="tushuForm.shujiaValue"
                                  placeholder="书架" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <!--<el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="状态" prop="jieyuejiluTypes">
                        <el-select v-model="ruleForm.jieyuejiluTypes" :disabled="ro.jieyuejiluTypes" placeholder="请选择状态">
                            <el-option
                                v-for="(item,index) in jieyuejiluTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="状态" prop="jieyuejiluValue">
                        <el-input v-model="ruleForm.jieyuejiluValue"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jieyuejilu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jieyuejiluTypesOptions = data.data.list;
                    }
                });
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='tushuId'){
                          this.ruleForm.tushuId = obj[o];
                          this.ro.tushuId = true;
                          continue;
                      }
                      if(o=='yonghuId'){
                      ...
                      if(o=='jieyuejiluTypes'){
                          this.ruleForm.jieyuejiluTypes = obj[o];
                          this.ro.jieyuejiluTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.tushuChange(data.data.tushuId)
